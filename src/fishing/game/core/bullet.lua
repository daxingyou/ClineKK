...
function Bullet:createDefaultBullet()
    if self.isFrames == true then
        ...
        if self.bulleltFrame == nil then
            ...
            local pFrame = sharedSpriteFrameCache:getSpriteFrame("zd"..self.paoLevel.."_level_1.png");
        ...
        local frames = display.newFrames("zd"..self.paoLevel.."_level_%d.png", 1, 4);
...
function Bullet:showNet(fish)
    ...
    if not self.bulleltWangFrame then
        display.loadSpriteFrames("fishing/fishing/fort.plist","fishing/fishing/fort.png")
        local fileName = "wang"..lv.."_1.png";
    ...
    if self.bulleltWangFrame then
        ...
        local frames = display.newFrames("wang"..lv.."_%d.png", 1, 7);

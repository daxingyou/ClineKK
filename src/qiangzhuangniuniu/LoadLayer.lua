...
function LoadLayer:initData()
	...
	self.sounds = {
					"sound/banker_lose_all.mp3",
					"sound/banker_win_all.mp3",
					"sound/fapai.mp3",
					"sound/fly_gold.mp3",
					"sound/game_start.mp3",
					"sound/lose.mp3",
					"sound/qiangzhuang_nan.mp3",
					"sound/qiangzhuang_nv.mp3",
					"sound/random_banker.mp3",
					"sound/win.mp3",
					"sound/xz_start.mp3",
					"sound/set_banker.mp3",
					"sound/select_card.mp3",
					}
	...
	self.skeleton = {
						{"niutype", "texiao/niu/qiangzhuangniuniupaixing.json", "texiao/niu/qiangzhuangniuniupaixing.atlas"},
						{"shengli", "texiao/shengli/shengli.json", "texiao/shengli/shengli.atlas"},
						{"shibai", "texiao/shibai/shibai.json", "texiao/shibai/shibai.atlas"},
						{"kaishiyouxi", "texiao/kaishiyouxi/kaishiyouxi.json", "texiao/kaishiyouxi/kaishiyouxi.atlas"},
						{"jijiangkaishi", "game/jijiangkaishi.json", "game/jijiangkaishi.atlas"},
						{"tishizi", "texiao/tishizi/tishizi.json", "texiao/tishizi/tishizi.atlas"},
					}

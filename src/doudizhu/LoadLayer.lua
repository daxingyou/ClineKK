...
function LoadLayer:initUI()
	...
	local bg = ccui.ImageView:create("doudizhu/bg/ddz_beijingtu.png");
	...
	local logo = ccui.ImageView:create("doudizhu/bg/ddz_logo.png");
	logo:setPosition(size.width/2,size.height/5*3);
	bg:addChild(logo);

	local barBg = ccui.ImageView:create("doudizhu/bg/linebackground.png");
	barBg:setPosition(size.width/2,150);
	bg:addChild(barBg);

	local loadingBar = ccui.LoadingBar:create("doudizhu/bg/line.png");

...
local DeskInfoLayer = require("shisanzhang.DeskInfoLayer");
-- //桌子信息
...
function DeskNode:initData()
	if self.MaxCount==4 then
		self.pos = {{0,0.7},{0.5,0.4},{1,0.7},{0.5,1}}
	elseif self.MaxCount==6 then
		self.pos = {{0,0.7},{0.3,0.4},{0.7,0.4},{0.3,1},{0.7,1},{1,0.7}}
	elseif self.MaxCount==8 then
		self.pos = {{0,0.5},{0,0.9},{0.3,0.4},{0.7,0.4},{0.3,1},{0.7,1},{1,0.5},{1,0.9}}
	end
end

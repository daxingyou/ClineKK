...
function LoadLayer:initData()
	...
	self.sounds = {
					"sound/sound-fly-0.mp3",
					"sound/sound-fly-1.mp3",
					"sound/sound-fly-2.mp3",
					"sound/sound-fly-3.mp3",
					"sound/sound-fly-4.mp3",
					"sound/sound-fly-5.mp3",
					"sound/sound-fly-6.mp3",
					"sound/sound-fly-7.mp3",
					"sound/sound-fly-8.mp3",
					"sound/sound-fly-9.mp3",
					"sound/sound-fly-12.mp3",
					"sound/sound-fly-13.mp3",
					"sound/sound-fly-99.mp3",
					"sound/sound-fly-turn.mp3",
					"sound/sound-countdown.mp3",
					"sound/sound-jetton.mp3",
					"sound/zhuang-huan.mp3",
					"sound/sound-start-wager.mp3",
					"sound/sound-end-wager.mp3",
					}

	self.musics = {
					"sound/sound-fly-bg.mp3",
					}

	self.skeleton = {
						{"djstexiao", "game/daojishi/daojishi.json", "game/daojishi/daojishi.atlas"},
						{"houzi", "texiao/0/houzi.json", "texiao/0/houzi.atlas"},
						{"shizi", "texiao/1/shizi.json", "texiao/1/shizi.atlas"},
						{"xiongmao", "texiao/2/xiongmao.json", "texiao/2/xiongmao.atlas"},
						{"tuzi", "texiao/3/tuzi.json", "texiao/3/tuzi.atlas"},
						{"laoying", "texiao/4/laoying.json", "texiao/4/laoying.atlas"},
						{"kongque", "texiao/5/kongque.json", "texiao/5/kongque.atlas"},
						{"gezi", "texiao/6/gezi.json", "texiao/6/gezi.atlas"},
						{"yanzi", "texiao/7/yanzi.json", "texiao/7/yanzi.atlas"},
						{"shayu", "texiao/8/shayu.json", "texiao/8/shayu.atlas"},
						{"jinsha", "texiao/9/jinsha.json", "texiao/9/jinsha.atlas"},
						{"tongshatongpei", "texiao/10/tongshatongpei.json", "texiao/10/tongshatongpei.atlas"},
						{"zitiTip", "game/feiqinzoushou.json", "game/feiqinzoushou.atlas"},
					}

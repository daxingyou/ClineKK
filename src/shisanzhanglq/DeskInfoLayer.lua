...
function DeskInfoLayer:initUI()
	...
	deskNoBg:setPosition(size.width*0.2,size.height*0.95-25)
	...
	for k,v in pairs(userlist) do
		...
		infoBg:setPosition(self.bg:getContentSize().width*0.5+((k+1)%2*2-1)*235,sHeight-135/2-math.floor((k-1)/2)*135)

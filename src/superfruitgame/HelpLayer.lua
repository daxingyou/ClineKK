...
--    local tip = FontConfig.createWithSystemFont("每局游戏结算将收取盈利部分的"..(SettlementInfo:getConfigInfoByID(32)/10).."%作为服务费。",20,FontConfig.colorWhite);
...
--    end
    ...
    local line = ccui.ImageView:create("superfruitgame/superfruit_bg/bangzhunew.png");

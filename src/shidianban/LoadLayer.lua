...
function LoadLayer:initUI()
	...
	local bg = ccui.ImageView:create("shidianban/bg/sdb_loading.png");
	...
	local logo = ccui.ImageView:create("shidianban/bg/logo.png");
	logo:setPosition(size.width/2,450);
	bg:addChild(logo);

	local barBg = ccui.ImageView:create("shidianban/bg/linebackground.png");
	barBg:setPosition(size.width/2,150);
	bg:addChild(barBg);

	local loadingBar = ccui.LoadingBar:create("shidianban/bg/line.png");

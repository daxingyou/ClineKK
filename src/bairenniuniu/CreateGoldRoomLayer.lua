...
local CreateRoomHistory = require("bairenniuniu.CreateRoomHistory");
...
function CreateGoldRoomLayer:initUI()
	...
	local btn = ccui.Button:create("createRoom/qitachangci.png","createRoom/qitachangci-on.png")
	...
	local btn2 = ccui.Button:create("createRoom/four.png","createRoom/four-on.png")
	btn2:setPosition(btn1:getPositionX()-btn2:getContentSize().width/2-115,top:getContentSize().height/2)
	btn2:setTag(1)
	top:addChild(btn2)
	btn2:onClick(handler(self,self.enterGame))
	self.ruchangBtn = btn2
	btn2:setVisible(false);

	-- local btn = ccui.Button:create("game/tiyanchang.png","game/tiyanchang-on.png")
	-- btn:setPosition(x,btn:getContentSize().height/2)
	-- btn:setTag(3)
...
function CreateGoldRoomLayer:changeGameBtn(sender)
	local tag = sender
	...
	if tag == 1 then
		self.ruchangBtn:loadTextures("createRoom/ten.png","/ten-on.png")
		self.ruchangBtn:setTag(2)
	elseif tag == 2 then
		self.ruchangBtn:loadTextures("createRoom/four.png","/four-on.png")
		self.ruchangBtn:setTag(1)
	end	

	return self.ruchangBtn:getTag()
end
...
function CreateGoldRoomLayer:onClick(sender)
	...
	if tag == 1 then
		display.getRunningScene():addChild(require("bairenniuniu.PopUpLayer"):create());
	elseif tag == 2 then
		Hall:exitGame()
	end
end

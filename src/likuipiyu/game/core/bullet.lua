...
function Bullet:createDefaultBullet()
    if self.isFrames == true then
        ...
        if self.bulleltFrame == nil then
            ...
            local pFrame = sharedSpriteFrameCache:getSpriteFrame("lkpy_zd"..self.paoLevel.."_level_1.png");
        ...
        if self.bulleltFrame then
            ...
            luaPrint("lkpy_zd"..self.paoOption.."_level_"..self.paoLevel..".png")
        end

        local frames = display.newFrames("lkpy_zd"..self.paoLevel.."_level_%d.png", 1, 4);
...
function Bullet:showNet(fish)
    ...
    if not self.bulleltWangFrame then
        display.loadSpriteFrames("likuipiyu/fishing/lkpy_fort.plist","likuipiyu/fishing/lkpy_fort.png")
        local fileName = "lkpy_wang"..lv.."_1.png";
    ...
    if self.bulleltWangFrame then
        ...
        local frames = display.newFrames("lkpy_wang"..lv.."_%d.png", 1, 7);

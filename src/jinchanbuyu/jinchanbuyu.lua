...
jinchanbuyu.step = 0
jinchanbuyu.pushLayer = {}

function jinchanbuyu:start(params)
	self.name = "jinchanbuyu"
	self.plistName = {
	...
	elseif self.step == 1 then
		...
		layer = loadScript("jinchanbuyu.LoadLayer"):create(function() Hall:selectedGame(self.name,params) end)
		zorder = gameZorder
...
--所有游戏此函数不改
function jinchanbuyu:exitGame(dt,callback)
...
function jinchanbuyu:directExitGame()
	self.step = 0
	self.pushLayer = {}
	FishModule:destroyInstance()
	GameGoodsInfo:clear()

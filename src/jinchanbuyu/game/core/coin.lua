...
function Coin:initGui()
	...
	display.loadSpriteFrames("jinchanbuyu/fishing/scene/gold_jcby.plist", "jinchanbuyu/fishing/scene/gold_jcby.png")
	display.loadSpriteFrames("jinchanbuyu/fishing/scene/jcby_other_gold.plist", "jinchanbuyu/fishing/scene/jcby_other_gold.png")
	local frames = nil;
	if self.isLiquan == true then
	  ...
	  -- self:setScale(0.6)
		...
		if self.coinTag == 1 then
			frames = display.newFrames("jcby_goldf%d.png", 1, 5);
      	elseif self.coinTag == 2 then 
       		frames = display.newFrames("jcby_other_goldf%d.png", 1, 5);
       	else
